...
def main():
    img_folder = "images/train_syn1"
    labels_file = os.path.join(img_folder, "train_syn1.txt")
    ...
    base_ckpt = "checkpoints/basic_best.pth"
    ...
    for epoch in range(1, 9):
        ...
        for imgs, labels, widths in tqdm(loader, desc=f"[phase1] Epoch {epoch}"):
        ...
        print(f"[phase1] Epoch {epoch} avg loss: {avg_loss:.4f} avg CER (char-weighted): {avg_cer:.4f} skipped_samples_this_epoch: {skipped_samples_total}")
        ...
        if avg_cer < best_cer:
            ...
            print("Saved checkpoints/phase1_best.pth")
